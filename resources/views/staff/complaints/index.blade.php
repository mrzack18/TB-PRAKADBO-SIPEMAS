...
@section('content')
    ...
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div>
            <p class="text-slate-600 mt-1">Daftar semua pengaduan yang ditugaskan kepada Anda</p>
        </div>
                ...
                <tbody class="divide-y divide-slate-200">
                    @forelse($complaints as $complaint)
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-slate-600">{{ $complaint->user->name }}</td>
                                    <td class="px-6 py-4">
                                        <span
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-slate-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-base font-medium text-slate-900">Tidak ada pengaduan</p>
                                    <p class="text-sm mt-1">Belum ada pengaduan yang ditugaskan kepada Anda atau dibuat oleh
                                        Anda.</p>
                                </div>
                            </td>
                        </tr>
